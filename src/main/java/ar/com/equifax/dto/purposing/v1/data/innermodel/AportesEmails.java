...
public class AportesEmails {
    ...
    public String toString() {
        return "AportesEmails [origen=" + origen + ", adhmatriz=" + adhmatriz
                + ", primeraVezAportadoFh=" + primeraVezAportadoFh
                + ", ultimaVezAportadoFh=" + ultimaVezAportadoFh
                + ", cantAportes=" + cantAportes + ", operaciones="
                + operaciones + "]";
    }
